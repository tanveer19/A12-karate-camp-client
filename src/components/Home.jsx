      ...
      <animated.div>
        ...
        <div className="collapse collapse-plus bg-base-200">
          ...
          <div className="collapse-content">
            ...
            <p>
              2. Yellow Belt (9th Kyu): The yellow belt indicates that the
              student has progressed in their training and has acquired a basic
              understanding of Kyokushin techniques.
            </p>
            <p>
              3. Orange Belt (8th Kyu): The orange belt represents an
              intermediate level of proficiency and shows that the student has
              developed a solid foundation of fundamental techniques.
            </p>
            <p>
            ...
            <p>
              5. Blue Belt (6th Kyu): The blue belt indicates that the student
              has reached an intermediate level of expertise and has
              demonstrated proficiency in a wide range of techniques.
            </p>
            <p>
        ...
        <div className="collapse collapse-plus bg-base-200">
          ...
          <div className="collapse-content">
            ...
            <p>
              Additionally, Kyokushin Karate places significance on kata
              training, which involves practicing choreographed sequences of
              movements to develop balance, coordination, technique precision,
              and mental focus.
            </p>

            <p>
              The belt ranking system is used in Kyokushin to mark progress and
              skill levels. Starting from the white belt, students advance
              through various colored belts until reaching the prestigious black
              belt, which is further divided into ten degrees or dans.
            </p>
          </div>
        </div>
        <div className="collapse collapse-plus bg-base-200">
